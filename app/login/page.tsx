...
import { LogIn, X, Shield, FileText, AlertCircle, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center bg-white px-4 pt-20 pb-10 overflow-hidden font-sans text-[#2d2e2e]">
      ...
      <div className="z-10 w-full max-w-[400px] flex flex-col items-center">
        ...
        <p className="text-sm text-gray-500 mb-8">to continue to your Hodi Ombath account.</p>
        ...
        <div className="w-full space-y-4">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-4 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-lg placeholder:text-gray-400"
            />
          </div>

          <button
            className="w-full py-4 bg-[#cccccc] text-white font-semibold rounded-lg cursor-not-allowed transition-colors"
            disabled
          >
            Continue
          </button>
          ...
          <div className="grid grid-cols-1 gap-3">
            <button
              onClick={handleLogin}
              className="flex items-center justify-center gap-3 w-full py-3 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-colors"
            >
            ...
            <button
              className="flex items-center justify-center gap-3 w-full py-3 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-colors opacity-50 cursor-not-allowed"
              disabled
            >
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.05 20.28c-.96.95-2.21 1.72-3.71 1.72-2.85 0-5.39-1.56-6.17-4.53H3.6l-.01.01c-1.32 2.02-3.14 3.66-5.28 4.74l3.57 2.77c1.82-1.68 4.31-2.66 7.28-2.66 4.3 0 8.01-2.47 9.82-6.07l-3.66-2.84c-.81 2.34-2.83 4.14-5.27 4.14zM12 5.38c1.62 0 3.06.56 4.21 1.66l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 12-4.53z" />
              </svg>
              Continue with Apple
            </button>
          </div>
        ...
        <div className="mt-12 text-center text-sm space-y-4">
          ...
          <p className="text-gray-600">
            Can't sign in?{" "}
            <button className="text-blue-600 font-medium hover:underline">Click here</button>
          </p>
        </div>
