            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${filterMood === null
                ...
                {moods.map((mood) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-sm font-medium capitalize transition-colors ${filterMood === mood
                        ? 'bg-primary text-primary-foreground'
                        : 'bg-muted text-muted-foreground hover:bg-primary/20'
                      }`}
                  >
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex gap-4 border-b border-border">
              ...
              <button
                ...
                className={`px-4 py-2 font-medium transition-colors border-b-2 ${activeTab === 'collections'
                    ? 'border-primary text-foreground'
                    : 'border-transparent text-muted-foreground hover:text-foreground'
                  }`}
              >
